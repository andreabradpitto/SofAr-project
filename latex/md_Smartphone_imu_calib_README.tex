This repository contains a R\+OS package with tools for computing and applying calibration parameters to I\+MU measurements.\hypertarget{md_Smartphone_imu_calib_README_autotoc_md10}{}\doxysection{Usage}\label{md_Smartphone_imu_calib_README_autotoc_md10}
The package contains two nodes. The first computes the accelerometer calibration parameters and saves them to a Y\+A\+ML file, and needs to be run only once. After you have run this node to generate the Y\+A\+ML calibration file, the second node uses that file to apply the calibration to an uncalibrated I\+MU topic to produce a calibrated I\+MU topic.\hypertarget{md_Smartphone_imu_calib_README_autotoc_md11}{}\doxysection{Nodes}\label{md_Smartphone_imu_calib_README_autotoc_md11}
\hypertarget{md_Smartphone_imu_calib_README_autotoc_md12}{}\doxysubsection{do\+\_\+calib}\label{md_Smartphone_imu_calib_README_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{md_Smartphone_imu_calib_README_autotoc_md16}{}\doxysubsection{apply\+\_\+calib}\label{md_Smartphone_imu_calib_README_autotoc_md16}
Applies the accelerometer calibration parameters computed by the do\+\_\+calib node. Also optionally (enabled by default) computes the gyro biases at startup and subtracts them off.\hypertarget{md_Smartphone_imu_calib_README_autotoc_md17}{}\doxysubsubsection{Topics}\label{md_Smartphone_imu_calib_README_autotoc_md17}
\hypertarget{md_Smartphone_imu_calib_README_autotoc_md18}{}\doxyparagraph{Subscribed Topics}\label{md_Smartphone_imu_calib_README_autotoc_md18}

\begin{DoxyItemize}
\item {\ttfamily raw} (sensor\+\_\+msgs/\+Imu) ~\newline
 The raw, uncalibrated I\+MU measurements
\end{DoxyItemize}\hypertarget{md_Smartphone_imu_calib_README_autotoc_md19}{}\doxyparagraph{Published Topics}\label{md_Smartphone_imu_calib_README_autotoc_md19}

\begin{DoxyItemize}
\item {\ttfamily corrected} (sensor\+\_\+msgs/\+Imu) ~\newline
 The corrected, calibrated I\+MU measurements
\end{DoxyItemize}\hypertarget{md_Smartphone_imu_calib_README_autotoc_md20}{}\doxysubsubsection{Parameters}\label{md_Smartphone_imu_calib_README_autotoc_md20}
