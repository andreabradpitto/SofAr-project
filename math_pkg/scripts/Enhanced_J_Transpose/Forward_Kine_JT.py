...
# matrix containing the axes needed by Jtransp.
...
def main_callback():
    ...
    global axis_vect, x_0e_kmin1B, x_0e_k, v_0e_kmin1B, v_0e_k, a_0e, omega_0e, R0e_kmin1, R0e_k, Jkmin1
    ...
    ###############################
    # New part
    ax = util.init_float64_multiarray(27, 1)
    ax.data = axis_vect.reshape(27, 1)
    pub_axes.publish(ax)
    ###############################
