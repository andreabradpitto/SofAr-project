...
def readDataFromSensors(data):
	...
	rospy.loginfo("Measure angles: %lf %lf %lf", angles[0], angles[1], angles[2])
	rospy.loginfo("Measure ang vel: %lf %lf %lf", angular_velocity[0], angular_velocity[1], angular_velocity[2])
	rospy.loginfo("Measure lin acc: %lf %lf %lf\n", linear_acceleration[0], linear_acceleration[1], linear_acceleration[2])
...
def callback(data):
	...
	rospy.loginfo("Kalman angles: %lf %lf %lf", angles_hat[0], angles_hat[1], angles_hat[2])
